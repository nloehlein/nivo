...
import { withHierarchy, withDimensions, withTheme, withMotion, withColors } from '@x-nivo/core'
import { getAccessorFor, getLabelGenerator } from '@x-nivo/core'
import { treeMapTileFromProp } from '@x-nivo/core'
import { getInheritedColorGenerator } from '@x-nivo/core'
import { bindDefs } from '@x-nivo/core'
